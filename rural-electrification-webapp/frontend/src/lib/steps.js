...
export const STEPS = [
  ...
  },
  {
    ...
    path: "/solar-design",
    title: "System Design",
    stepperLabel: "SYSTEM DESIGN",
    tagline: "Size and configure the generation system",
    description: "Solar PV or wind turbine generation, sized with a battery or a diesel generator.",
